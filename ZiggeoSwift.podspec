#
# Be sure to run `pod lib lint ZiggeoSwift.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.vendored_frameworks = 'Frameworks/SelfieSegmentation.framework', 'Frameworks/ZiggeoSwift.framework'
