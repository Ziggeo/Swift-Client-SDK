...
#import "/Volumes/Data/Working/Ziggeo/iOS/07_Swift-SDK-Blurring/ZiggeoSwiftFramework-Bridging-Header.h"
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework9AudioData")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework14AudioLevelView")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework18AudioPlayerManager")
...
@interface AudioPlayerManager (SWIFT_EXTENSION(ZiggeoSwiftFramework)) <AVAudioPlayerDelegate>
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer * _Nonnull)player successfully:(BOOL)flag;
@end


SWIFT_CLASS("_TtC20ZiggeoSwiftFramework20AudioRecorderManager")
...
@interface AudioRecorderManager (SWIFT_EXTENSION(ZiggeoSwiftFramework)) <AVAudioRecorderDelegate>
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework15AudioStreamData")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework12ContentModel")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework14DeviceInfoData")
@interface DeviceInfoData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC20ZiggeoSwiftFramework4Face")
@interface Face : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC20ZiggeoSwiftFramework15FaceOutlineView")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework12FileInfoData")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework9ImageData")
@interface ImageData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC20ZiggeoSwiftFramework15ImageStreamData")
@interface ImageStreamData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC20ZiggeoSwiftFramework12LuxMeterView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework11RangeSlider")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework21RangeSliderThumbLayer")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework21RangeSliderTrackLayer")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework18ScalableConstraint")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework14TPGAudioPlayer")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework9VideoData")
@interface VideoData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC20ZiggeoSwiftFramework15VideoStreamData")
...
@interface Ziggeo (SWIFT_EXTENSION(ZiggeoSwiftFramework)) <MFMailComposeViewControllerDelegate>
...
SWIFT_PROTOCOL("_TtP20ZiggeoSwiftFramework26ZiggeoQRCodeReaderDelegate_")
@protocol ZiggeoQRCodeReaderDelegate
- (void)ziggeoQRCodeScaned:(NSString * _Nonnull)qrCode;
@end


SWIFT_CLASS("_TtC20ZiggeoSwiftFramework32ZiggeoQRCodeReaderViewController")
...
@interface ZiggeoQRCodeReaderViewController (SWIFT_EXTENSION(ZiggeoSwiftFramework)) <AVCaptureMetadataOutputObjectsDelegate>
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework26ZiggeoRecordedVideoPreview")
...
@interface ZiggeoRecorder (SWIFT_EXTENSION(ZiggeoSwiftFramework)) <AVCaptureMetadataOutputObjectsDelegate>
- (void)captureOutput:(AVCaptureMetadataOutput * _Nonnull)output didOutputMetadataObjects:(NSArray<AVMetadataObject *> * _Nonnull)metadataObjects fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

@class SelfieSegmentation;

@interface ZiggeoRecorder (SWIFT_EXTENSION(ZiggeoSwiftFramework)) <SelfieSegmentationDelegate>
...
@interface ZiggeoRecorder (SWIFT_EXTENSION(ZiggeoSwiftFramework)) <AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end



SWIFT_CLASS("_TtC20ZiggeoSwiftFramework33ZiggeoScreenRecorderSampleHandler")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework17ZiggeoVideoEditor")
...
SWIFT_CLASS("_TtC20ZiggeoSwiftFramework18ZiggeoVideoLibrary")
...
@interface ZiggeoVideoLibrary (SWIFT_EXTENSION(ZiggeoSwiftFramework)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
- (void)imagePickerController:(UIImagePickerController * _Nonnull)picker didFinishPickingMediaWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
- (void)imagePickerControllerDidCancel:(UIImagePickerController * _Nonnull)picker;
