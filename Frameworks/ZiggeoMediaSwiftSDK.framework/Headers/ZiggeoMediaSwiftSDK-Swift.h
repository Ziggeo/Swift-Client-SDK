...
@interface CoverSelector : UIViewController
...
@interface CoverSelector (SWIFT_EXTENSION(ZiggeoMediaSwiftSDK)) <UITableViewDelegate>
...
@interface CoverSelector (SWIFT_EXTENSION(ZiggeoMediaSwiftSDK)) <UITableViewDataSource>
...
- (void)seekPlayerToTimeWithValue:(double)value completion:(void (^ _Nullable)(void))completion;
@end
...
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithPlayerItem:(AVPlayerItem * _Nullable)playerItem SWIFT_UNAVAILABLE;
...
- (void)selfieSegmentation:(SelfieSegmentation * _Null_unspecified)selfieSegmentation didOutputPixelBuffer:(CVPixelBufferRef _Null_unspecified)pixelBuffer cmTime:(CMTime)cmTime;
@end
...
@interface ZiggeoRecorder (SWIFT_EXTENSION(ZiggeoMediaSwiftSDK))
