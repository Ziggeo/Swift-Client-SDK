...
#ifndef ZIGGEOSWIFT_SWIFT_H
#define ZIGGEOSWIFT_SWIFT_H
...
#import "/Volumes/Data/Working/Ziggeo/iOS/07_ZiggeoSwift-Blurring/ZiggeoSwift-Bridging-Header.h"
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ZiggeoSwift",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
# pragma pop_macro("any")
#endif



SWIFT_CLASS("_TtC11ZiggeoSwift9AudioData")
...
SWIFT_CLASS("_TtC11ZiggeoSwift14AudioLevelView")
...
SWIFT_CLASS("_TtC11ZiggeoSwift18AudioPlayerManager")
...
@interface AudioPlayerManager (SWIFT_EXTENSION(ZiggeoSwift)) <AVAudioPlayerDelegate>
- (void)audioPlayerDidFinishPlaying:(AVAudioPlayer * _Nonnull)player successfully:(BOOL)flag;
@end


SWIFT_CLASS("_TtC11ZiggeoSwift20AudioRecorderManager")
...
@interface AudioRecorderManager (SWIFT_EXTENSION(ZiggeoSwift)) <AVAudioRecorderDelegate>
...
SWIFT_CLASS("_TtC11ZiggeoSwift15AudioStreamData")
...
///   </li>
/// </ul>
SWIFT_CLASS("_TtC11ZiggeoSwift11BaseNibView")
...
SWIFT_CLASS("_TtC11ZiggeoSwift22AudioVisualizationView")
...
SWIFT_CLASS("_TtC11ZiggeoSwift18CapturePreviewView")
...
SWIFT_CLASS("_TtC11ZiggeoSwift11Chronometer")
...
SWIFT_CLASS("_TtC11ZiggeoSwift12ContentModel")
...
SWIFT_CLASS("_TtC11ZiggeoSwift13CoverSelector")
...
SWIFT_CLASS("_TtC11ZiggeoSwift22CoverSelectorTableCell")
...
SWIFT_CLASS("_TtC11ZiggeoSwift14DeviceInfoData")
@interface DeviceInfoData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11ZiggeoSwift4Face")
@interface Face : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11ZiggeoSwift15FaceOutlineView")
...
SWIFT_CLASS("_TtC11ZiggeoSwift12FileInfoData")
...
SWIFT_CLASS("_TtC11ZiggeoSwift9ImageData")
@interface ImageData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11ZiggeoSwift15ImageStreamData")
@interface ImageStreamData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11ZiggeoSwift12LuxMeterView")
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC11ZiggeoSwift11RangeSlider")
...
SWIFT_CLASS("_TtC11ZiggeoSwift21RangeSliderThumbLayer")
...
SWIFT_CLASS("_TtC11ZiggeoSwift21RangeSliderTrackLayer")
...
SWIFT_CLASS("_TtC11ZiggeoSwift18ScalableConstraint")
...
SWIFT_CLASS("_TtC11ZiggeoSwift14TPGAudioPlayer")
...
SWIFT_CLASS("_TtC11ZiggeoSwift9VideoData")
@interface VideoData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11ZiggeoSwift15VideoStreamData")
@interface VideoStreamData : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC11ZiggeoSwift9ViewModel")
...
SWIFT_CLASS("_TtC11ZiggeoSwift6Ziggeo")
...
@interface Ziggeo (SWIFT_EXTENSION(ZiggeoSwift)) <MFMailComposeViewControllerDelegate>
- (void)mailComposeController:(MFMailComposeViewController * _Nonnull)controller didFinishWithResult:(MFMailComposeResult)result error:(NSError * _Nullable)error;
@end

@class UIImagePickerController;

@interface Ziggeo (SWIFT_EXTENSION(ZiggeoSwift)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
...
SWIFT_CLASS("_TtC11ZiggeoSwift17ZiggeoAudioPlayer")
...
SWIFT_CLASS("_TtC11ZiggeoSwift19ZiggeoAudioRecorder")
...
SWIFT_CLASS("_TtC11ZiggeoSwift12ZiggeoAudios")
...
SWIFT_CLASS("_TtC11ZiggeoSwift18ZiggeoCacheManager")
...
SWIFT_CLASS("_TtC11ZiggeoSwift12ZiggeoConfig")
...
SWIFT_CLASS("_TtC11ZiggeoSwift13ZiggeoConnect")
...
SWIFT_PROTOCOL("_TtP11ZiggeoSwift14ZiggeoDelegate_")
...
SWIFT_CLASS("_TtC11ZiggeoSwift12ZiggeoImages")
...
SWIFT_CLASS("_TtC11ZiggeoSwift12ZiggeoPlayer")
...
SWIFT_PROTOCOL("_TtP11ZiggeoSwift26ZiggeoQRCodeReaderDelegate_")
@protocol ZiggeoQRCodeReaderDelegate
- (void)ziggeoQRCodeScaned:(NSString * _Nonnull)qrCode;
@end


SWIFT_CLASS("_TtC11ZiggeoSwift32ZiggeoQRCodeReaderViewController")
...
@interface ZiggeoQRCodeReaderViewController (SWIFT_EXTENSION(ZiggeoSwift)) <AVCaptureMetadataOutputObjectsDelegate>
...
SWIFT_CLASS("_TtC11ZiggeoSwift26ZiggeoRecordedVideoPreview")
...
SWIFT_CLASS("_TtC11ZiggeoSwift14ZiggeoRecorder")
...
@interface ZiggeoRecorder (SWIFT_EXTENSION(ZiggeoSwift)) <AVCaptureMetadataOutputObjectsDelegate>
- (void)captureOutput:(AVCaptureMetadataOutput * _Nonnull)output didOutputMetadataObjects:(NSArray<AVMetadataObject *> * _Nonnull)metadataObjects fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

@class SelfieSegmentation;

@interface ZiggeoRecorder (SWIFT_EXTENSION(ZiggeoSwift)) <SelfieSegmentationDelegate>
...
@interface ZiggeoRecorder (SWIFT_EXTENSION(ZiggeoSwift)) <AVCaptureAudioDataOutputSampleBufferDelegate, AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end



SWIFT_CLASS("_TtC11ZiggeoSwift33ZiggeoScreenRecorderSampleHandler")
...
SWIFT_CLASS("_TtC11ZiggeoSwift22ZiggeoUploadingHandler")
...
SWIFT_CLASS("_TtC11ZiggeoSwift17ZiggeoVideoEditor")
...
SWIFT_CLASS("_TtC11ZiggeoSwift18ZiggeoVideoLibrary")
...
@interface ZiggeoVideoLibrary (SWIFT_EXTENSION(ZiggeoSwift)) <UIImagePickerControllerDelegate, UINavigationControllerDelegate>
- (void)imagePickerController:(UIImagePickerController * _Nonnull)picker didFinishPickingMediaWithInfo:(NSDictionary<UIImagePickerControllerInfoKey, id> * _Nonnull)info;
- (void)imagePickerControllerDidCancel:(UIImagePickerController * _Nonnull)picker;
...
SWIFT_CLASS("_TtC11ZiggeoSwift12ZiggeoVideos")
